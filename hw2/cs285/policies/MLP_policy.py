...
class MLPPolicy(BasePolicy):
    ...
    def get_action(self, obs):
        ...
        return self.sess.run(self.sample_ac, feed_dict = {self.observations_pl: observation})#TODO
...
class MLPPolicySL(MLPPolicy):
    ...
    def define_train_op(self):
        ...
        self.loss = tf.losses.mean_squared_error(true_actions, predicted_actions) #TODO
...
class MLPPolicyPG(MLPPolicy):
    ...
    def define_train_op(self):
        ...
        self.train_op = tf.train.AdamOptimizer(self.learning_rate).minimize(self.loss)#TODO)
        ...
        if self.nn_baseline:
            ...
            self.baseline_loss = tf.losses.mean_squared_error(self.targets_n, self.baseline_prediction)#TODO

            # TODO: define what exactly the optimizer should minimize when updating the baseline
            self.baseline_update_op = tf.train.AdamOptimizer(self.learning_rate).minimize(self.baseline_loss) #TODO)
    ...
    def run_baseline_prediction(self, obs):
        ...
        a = self.sess.run(self.baseline_prediction, feed_dict={self.observations_pl: obs})
        return a #TODO
