...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        return self.obs[random_indices], self.acs[random_indices], self.rews[random_indices], self.next_obs[random_indices], self.terminals[random_indices]#TODO, TODO, TODO, TODO, TODO
