...
class BootstrappedContinuousCritic(BaseCritic):
    ...
    def _build(self):
        ...
        self.critic_loss = tf.losses.mean_squared_error(self.sy_target_n, self.critic_prediction) #TODO

        # TODO: use the AdamOptimizer to optimize the loss defined above
        self.critic_update_op = tf.train.AdamOptimizer(self.learning_rate).minimize(self.critic_loss) #TODO
    ...
    def forward(self, ob):
        ...
        return self.sess.run(self.critic_prediction, feed_dict={self.sy_ob_no: ob})#TODO
