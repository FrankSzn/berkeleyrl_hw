...
class FFModel(BaseModel):
    ...
    def define_forward_pass(self):
        ...
        self.delta_pred_normalized = build_mlp(concatenated_input, self.ob_dim, self.scope,\
                                               self.n_layers, self.size)# TODO(Q1) Use the build_mlp function and the concatenated_input above to define a neural network that predicts unnormalized delta states (i.e. change in state)
