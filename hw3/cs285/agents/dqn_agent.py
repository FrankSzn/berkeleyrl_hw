    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        if (self.t > self.learning_starts and \
            ...
            feed_dict = {
                ...
                self.critic.obs_t_ph: ob_no,#TODO,
                self.critic.act_t_ph: ac_na,#TODO,
                self.critic.rew_t_ph: re_n,#TODO,
                self.critic.obs_tp1_ph: next_ob_no,#TODO,
                self.critic.done_mask_ph: terminal_n,#TODO,
            }

            # TODO: create a LIST of tensors to run in order to 
            # train the critic as well as get the resulting total_error
            tensors_to_run = [self.critic.total_error, self.critic.train_fn]#TODO
            ...
            if self.num_param_updates % self.target_update_freq == 0:
                #TODO
                self.sess.run(self.critic.update_target_fn, feed_dict)
